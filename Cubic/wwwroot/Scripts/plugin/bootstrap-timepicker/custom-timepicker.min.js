...
!(function (a, b, c, d) {
    ...
    (e.prototype = {
        ...
        getTemplate: function () {
            ...
            switch (
                ...
                (f =
                    ...
                    (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" class="btn btn-sm btn-default" data-action="incrementSecond"><i class="fa fa-chevron-up"></i></a></td>' : "") +
                    (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" class="btn btn-sm btn-default" data-action="toggleMeridian"><i class="fa fa-chevron-up"></i></a></td>' : "") +
                    "</tr><tr><td>" +
                    b +
                    ...
                    (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" class="btn btn-sm btn-default" data-action="decrementSecond"><i class="fa fa-chevron-down"></i></a></td>' : "") +
                    (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" class="btn btn-sm btn-default" data-action="toggleMeridian"><i class="fa fa-chevron-down"></i></a></td>' : "") +
                    "</tr></table>"),
                this.template)
            ) {
                case "modal":
        ...
        getTime: function () {
            return "" === this.hour
                ? ""
                : (1 === this.hour.toString().length ? "0" + this.hour : this.hour) +
                      ":" +
        ...
        incrementHour: function () {
            ...
            return this.hour++; // 23 === this.hour ? void (this.hour = 0) : void this.hour++;
        },
            ...
            if (!this.isInline) {
                ...
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"),
                    "auto" !== this.orientation.x
                        ? (this.picker.addClass("datepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (m -= c - l))
        ...
        setTime: function (a, b) {
            ...
            "object" == typeof a && a.getMonth
                ? ((d = a.getHours()), (e = a.getMinutes()), (f = a.getSeconds()), this.showMeridian && ((g = "AM"), d > 12 && ((g = "PM"), (d %= 12)), 12 === d && (g = "PM")))
            ...
            //d.length > 2 && ((e = d.substr(2, 2)), (d = d.substr(0, 2))),
              d.length > 2 && ((e = d.substr(2, 2)), (d = d)),
                  ...
                  isNaN(e) && (e = 0),
                  isNaN(f) && (f = 0),
                  this.showMeridian ? (1 > d ? (d = 1) : d > 12 && (d = 12)) : (d >= 24 ? (d = d) : 0 > d && (d = 0), 13 > d && "PM" === g && (d += 12)),
                  0 > e ? (e = 0) : e >= 60 && (e = 59),
                  this.showSeconds && (isNaN(f) ? (f = 0) : 0 > f ? (f = 0) : f >= 60 && (f = 59))),
                (this.hour = d),
                (this.minute = e),
                (this.second = f),
                (this.meridian = g),
        ...
        updateWidget: function () {
            if (this.$widget !== !1) {
                var a = 1 === this.hour.toString().length ? "0" + this.hour : this.hour,
        ...
        widgetKeyup: function (a) {
            (65 === a.keyCode || 77 === a.keyCode || 80 === a.keyCode || 46 === a.keyCode || 8 === a.keyCode || (a.keyCode >= 46 && a.keyCode <= 105)) && this.updateFromWidgetInputs();
        },
    }),
